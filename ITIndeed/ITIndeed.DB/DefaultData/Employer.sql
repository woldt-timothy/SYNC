...
SELECT @eUserId3 = Id from tblUser where [UserName] = 'abby3'
	...
	VALUES
	(NEWID(), 'Alex', 'Smith','(920)111-1111','alex@bemis.com',@eUserId1,'Bemis Company','Manufacturing'),
	(NEWID(), 'Jess', 'Jones','(920)222-2222','jess@oshkoshtruck.com',@eUserId2, 'Oshkosh Truck', 'Manufacturing'),
	(NEWID(), 'Abby', 'Williams','(920)333-3333','abby@thrivent.com',@eUserId3, 'Thrivent Financial', 'Finance')
END